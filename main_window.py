...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.price_5m = QtWidgets.QLineEdit(self.groupBox_6)
        self.price_5m.setEnabled(False)
        self.price_5m.setText("")
